...
class ModelParams():
    """
    Class to hold LLM model parameters (e.g., API keys).
    """

    def __init__(self):
        """
        Initializes model parameters, setting up environment variable pointers.
        """
    ...
    def SetArgs(self,args:argparse.Namespace):
        """
        Sets the LLM API keys based on command-line arguments or environment variables.
